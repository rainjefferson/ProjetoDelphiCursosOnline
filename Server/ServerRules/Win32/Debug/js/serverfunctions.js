...
function TSMRegras(connectionInfo)
{
  this.executor = new ServerFunctionExecutor("TSMRegras",connectionInfo);
   ...
   * @return result - Type on server: string
   */
  this.UrlVideoAula = function() {
    var returnObject = this.executor.executeMethod('UrlVideoAula', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.UrlVideoAula_URL = function() {
    return this.executor.getMethodURL("UrlVideoAula", "GET", [], arguments[0])[0];
  };

  /*
   * @return result - Type on server: string
   */
  this.UrlTelaUserPlayer = function() {
    var returnObject = this.executor.executeMethod('UrlTelaUserPlayer', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.UrlTelaUserPlayer_URL = function() {
    return this.executor.getMethodURL("UrlTelaUserPlayer", "GET", [], arguments[0])[0];
  };
   ...
   * @return result - Type on server: Boolean
   */
  this.UsuarioLogado = function(Value) {
    var returnObject = this.executor.executeMethod('UsuarioLogado', "GET", [Value], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.UsuarioLogado_URL = function(Value) {
    return this.executor.getMethodURL("UsuarioLogado", "GET", [Value], arguments[1])[0];
  };

  /*
   * @param User [in] - Type on server: string
   * @param Password [in] - Type on server: string
   * @param IdDevice [in] - Type on server: string
   * @return result - Type on server: Boolean
   */
  this.AutenticarUsuario = function(User, Password, IdDevice) {
    var returnObject = this.executor.executeMethod('AutenticarUsuario', "GET", [User, Password, IdDevice], arguments[3], true, arguments[4], arguments[5]);
    if (arguments[3] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
        ...
        resultObject.IdDevice = IdDevice;
        resultObject.result = resultArray[0];
        return resultObject;
      }
      return returnObject;
  ...
  this.AutenticarUsuario_URL = function(User, Password, IdDevice) {
    return this.executor.getMethodURL("AutenticarUsuario", "GET", [User, Password, IdDevice], arguments[3])[0];
  };

  /*
   * @param User [in] - Type on server: string
   * @param IdCurso [in] - Type on server: string
   */
  this.AdicionarCursoFavorito = function(User, IdCurso) {
    this.executor.executeMethod('AdicionarCursoFavorito', "GET", [User, IdCurso], arguments[2], false, arguments[3], arguments[4]);
  };

  this.AdicionarCursoFavorito_URL = function(User, IdCurso) {
    return this.executor.getMethodURL("AdicionarCursoFavorito", "GET", [User, IdCurso], arguments[2])[0];
  };

  /*
   * @param User [in] - Type on server: string
   */
  this.Sair = function(User) {
    this.executor.executeMethod('Sair', "GET", [User], arguments[1], false, arguments[2], arguments[3]);
  };

  this.Sair_URL = function(User) {
    return this.executor.getMethodURL("Sair", "GET", [User], arguments[1])[0];
  };
}
...
var JSProxyClassList = {
  ...
  "TSMRegras": ["EchoString","ReverseString","UrlVideoAula","UrlTelaUserPlayer","UsuarioLogado","AutenticarUsuario","AdicionarCursoFavorito","Sair"]
};
