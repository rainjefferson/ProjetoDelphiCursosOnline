...
uses
  ...
  uniGUIClasses, uniGUIRegClasses, uniGUIForm, uniFieldSet,
  uniImage, uniGUIBaseClasses,
...
begin
  if FileExists(UniServerModule.PastaFiles + 'botao_confirmar.png') then
    imgBotaoConfirmar.Picture.LoadFromFile(UniServerModule.PastaFiles + 'botao_confirmar.png');
